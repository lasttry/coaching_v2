...
import { AthleteSize } from '@prisma/client';
...
const AthletesPage: React.FC = () => {
  ...
  const [selectedAthlete, setSelectedAthlete] = useState<AthleteInterface>({
    id: 0,
    name: '',
    birthdate: '',
    shirtSize: AthleteSize.S,
    active: false,
  });
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') fetchAthletes(); // nota o "void" para TypeScript
  }, [fetchAthletes]);
      ...
      <Dialog open={openDialog} onClose={() => setOpenDialog(false)} maxWidth="md" fullWidth>
        ...
        <DialogContent>
          <AthleteAddComponent
            ...
            setNewAthlete={setSelectedAthlete}
