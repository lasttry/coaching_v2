...
export const DefaultColors = ['#003366', '#FF5733', '#FFC300', '#28B463', '#DAF7A6', '#6C3483', '#E74C3C', '#1F618D'];
...
export const ArrowIcon: React.FC<IconProps> = React.memo(({ onClick }) => {
  ...
  return (
    <svg version="1.1" width="30" height="30" viewBox="0 0 30 30" style={{ overflow: 'hidden' }} onClick={handleOnClick}>
      <defs>
        <path d="m 11,10 0,11.5 c 0.6,-1 1.2,-2 2,-2.5 l 2,5.5 2,-0.5 -2,-5.5 c 1,0 2.5,0 4,0.5 z" id="path"></path>
      </defs>
      <g>
...
export const OffenseIcon: React.FC<OffenseIconProps> = React.memo(({ textValue = 1, color = '#003366', x = 0, y = 0, onClick }) => {
  const handleOnClick = () => {
    if (onClick) onClick();
  };

  return (
    <g transform={`matrix(1,0,0,1,${x},${y})`} fill={color} stroke={color} className="offence" onClick={handleOnClick}>
  ...
  return (
    ...
    >
      ...
      <g onClick={handleDecrement} style={{ cursor: 'pointer' }}>
        <rect x="-3" y="31" width="17" height="11" fill="rgba(0,0,0,0)" stroke="#B0BEC5" style={{ strokeWidth: 1 }}></rect>
        <path d="m 8,34 -4,2 4,2" fill="rgba(0,0,0,0)" stroke="#37474F" style={{ strokeWidth: 1.5 }}></path>
      </g>
      <g onClick={handleIncrement} style={{ cursor: 'pointer' }}>
        <rect x="14" y="31" width="17" height="11" fill="rgba(0,0,0,0)" stroke="#B0BEC5" style={{ strokeWidth: 1 }}></rect>
        <path d="m 21,34 4,2 -4,2" fill="rgba(0,0,0,0)" stroke="#37474F" style={{ strokeWidth: 1.5 }}></path>
      </g>
    </svg>
  );
});
...
export const DefenseIcon: React.FC<{
  ...
  return (
    <g transform="matrix(0.8,0,0,0.8,15,16)" fill={color} stroke={color} className="defence" onClick={handleOnClick}>
      <g>
        <path d="m -20,10 c 10,-16 30,-16 40,0 -5,-24 -35,-24 -40,0" stroke="none" style={{ strokeWidth: 0 }}></path>
...
export const DefenseToolbarIcon: React.FC<{
  ...
  return (
    ...
    >
      ...
      <g onClick={handleDecrement} style={{ cursor: 'pointer' }}>
        <rect x="-3" y="31" width="17" height="11" fill="rgba(0,0,0,0)" stroke="#cfd8dc" style={{ strokeWidth: 1 }}></rect>
        <path d="m 8,34 -4,2 4,2" fill="rgba(0,0,0,0)" stroke="#455A64" style={{ strokeWidth: 1 }}></path>
      </g>
      <g onClick={handleIncrement} style={{ cursor: 'pointer' }}>
        <rect x="14" y="31" width="17" height="11" fill="rgba(0,0,0,0)" stroke="#cfd8dc" style={{ strokeWidth: 1 }}></rect>
        <path d="m 21,34 4,2 -4,2" fill="rgba(0,0,0,0)" stroke="#455A64" style={{ strokeWidth: 1 }}></path>
      </g>
    </svg>
  );
});
...
export const BallIcon: React.FC<{ onClick: () => void }> = React.memo(({ onClick }) => {
  ...
  return (
    <svg version="1.1" width="30" height="30" viewBox="0 0 16 16" style={{ overflow: 'hidden' }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export const ConeIcon: React.FC<{ onClick: () => void }> = React.memo(({ onClick }) => {
  ...
  return (
    <svg version="1.1" width="30" height="30" viewBox="0 0 30 30" style={{ overflow: 'hidden' }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export const CoachIcon: React.FC = React.memo(() => {
  return (
    <svg version="1.1" width="30" height="30" viewBox="0 0 30 30" style={{ overflow: 'hidden', userSelect: 'none' }} xmlns="http://www.w3.org/2000/svg">
      <g transform="matrix(1,0,0,1,15,16)" className="coach">
        <g>
          <circle cx="0" cy="0" r="10" fill="#ffffff" stroke="#de4814" style={{ strokeWidth: 2 }}></circle>
          <text
            x="-5.5"
            y="4.5"
            fill="#de4814"
...
export const AreaIcon: React.FC<ChangeColorIconProps> = React.memo(({ currentColor = '#003366', onColorChange }) => {
  ...
  return (
    <svg version="1.1" width="34" height="42" viewBox="-2 0 32 42" style={{ overflow: 'hidden' }} xmlns="http://www.w3.org/2000/svg">
      <g fill={DefaultColors[currentColorIndex]} style={{ opacity: 0.6, strokeWidth: 1 }} className="area" transform="matrix(1,0,0,1,1,3)" stroke="#333333">
        <ellipse cx="13" cy="13" rx="13" ry="13"></ellipse>
      </g>
      <g onClick={handleMoveLeft} style={{ cursor: 'pointer' }}>
        <rect x="-3" y="31" width="17" height="11" fill="rgba(0,0,0,0)" stroke="#dfdfdf" strokeWidth={1}></rect>
        <path d="m 8,34 -4,2 4,2" fill="rgba(0,0,0,0)" stroke="#000000" style={{ strokeWidth: 1 }}></path>
      </g>
      <g onClick={handleMoveRight} style={{ cursor: 'pointer' }}>
        <rect x="14" y="31" width="17" height="11" fill="rgba(0,0,0,0)" stroke="#dfdfdf" strokeWidth={1}></rect>
        <path d="m 21,34 4,2 -4,2" fill="rgba(0,0,0,0)" stroke="#000000" style={{ strokeWidth: 1 }}></path>
      </g>
    </svg>
  );
});
...
export const ChangeColorIcon: React.FC<ChangeColorIconProps> = React.memo(({ currentColor = '#003366', onColorChange }) => {
...
export const LineDribblingIcon: React.FC = React.memo(() => {
  return (
    <svg version="1.1" width="30" height="30" viewBox="0 0 30 30" style={{ overflow: 'hidden' }} xmlns="http://www.w3.org/2000/svg">
      <path d="m 3,16.5 1,0 c 2,0 2,2 4,2 2,0 2,-2 4,-2 2,0 2,2 4,2 2,0 2,-2 4,-2 l 1,0" fill="none" stroke="#000000" style={{ strokeWidth: 2 }}></path>
      <path d="m 26,17 -5,-5 0,10 z" fill="#000000" style={{ strokeWidth: 0 }}></path>
    </svg>
  );
});
...
export const ShootingIcon: React.FC = React.memo(() => {
  return (
    <svg version="1.1" width="30" height="30" viewBox="0 0 34 34" style={{ overflow: 'hidden' }} xmlns="http://www.w3.org/2000/svg">
      <g transform="matrix(1,0,0,1,-8,20)" stroke="#000000" className="shoot" style={{}}>
        <path d="m -9,-25 8,-14 8,14 -4,0 0,13 -7.5,0 0,-13 z" fill="#ffffff" transform="matrix(0,1,-1,0,0,0)" style={{ strokeWidth: 1 }}></path>
      </g>
    </svg>
  );
});
