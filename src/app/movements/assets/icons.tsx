...
export const OffenseIcon: React.FC<{ textValue?: number; color?: string; }> = React.memo(({ textValue = 1, color = '#003366' }) => {
  return (
    <g
...
export const OffenseToolbarIcon: React.FC<{ textValue?: number; color?: string; onChange: (value: number) => void }> = React.memo(({ textValue = 1, color = '#003366', onChange }) => {
  ...
  return (
    <svg
      ...
      height="42"
      viewBox="-2 0 32 42"
      style={{ overflow: 'hidden', userSelect: 'none', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0, 0, 0, 0.2)' }}
      xmlns="http://www.w3.org/2000/svg"
    >
      <OffenseIcon textValue={textValue} color={color} />
...
export const DefenseIcon: React.FC<{ textValue?: number; color?: string; onChange: (value: number) => void }> = React.memo(({ textValue = 1, color = '#455A64', onChange }) => {
  const handleIncrement = () => {
    const newValue = textValue === 9 ? 1 : textValue + 1;
    if (onChange) onChange(newValue);
  };
  ...
  return (
    <svg
      ...
      height="42"
      viewBox="-2 0 32 42"
      style={{ overflow: 'hidden', userSelect: 'none', borderRadius: '6px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.15)' }}
      xmlns="http://www.w3.org/2000/svg"
    >
      <g
...
export const BallIcon: React.FC = React.memo(() => {
  return (
    <svg
      version="1.1"
      width="30"
    ...
    >
      ...
      <g transform="matrix(1,0,0,1,8,9)" className="ball">
        <g>
          <ellipse
            cx="0"
            cy="0"
...
export const ConeIcon: React.FC = React.memo(() => {
  return (
    <svg
      version="1.1"
      width="30"
    ...
    >
      ...
      <g transform="matrix(1,0,0,1,15,16)" className="cone">
        <g>
          <path
...
export const HandoffIcon: React.FC = React.memo(() => {
  return (
    ...
    >
      ...
      >
        <path
          d="M -8,0 H 8 M 4,-8 V 8 M -4,-8 V 8"
          fill="none"
          style={{ strokeWidth: 2 }}
        ></path>
      </g>
...
export const ToggleHalfCourtIcon: React.FC<{ isFullCourt: boolean; onChange: (newState: boolean) => void }> = React.memo(({ isFullCourt = true, onChange }) => {
  ...
  return (
    <svg
      ...
      height="50"
      viewBox="0 0 30 50"
      style={{ overflow: 'hidden', borderRadius: '4px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', cursor: 'pointer' }}
      xmlns="http://www.w3.org/2000/svg"
      onClick={handleClick}
    >
      <defs>
      ...
      {!isFullCourt && (
        <rect x="0" y="25" width="30" height="25" fill="url(#bottomGradient)" />
      )}
